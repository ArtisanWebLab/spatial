...
class PostgresGrammar extends IlluminatePostgresGrammar
{
    /**
     * @param         $value
     * @param  false  $prefixAlias
     *
     * @return string
     */
    public function wrapST($value, $prefixAlias = false)
    {
     ...
     * @return string
     */
    public function STDistance($column, Point $point): string
    {
        return "ST_Distance({$column}, {$this->STGeomFromObject($point)}, false)";
    }
     ...
     * @return string
     */
    public function STDistanceSphere($column, Point $point): string
    {
        return "ST_Distance({$column}, {$this->STGeomFromObject($point)}, true)";
    }
    ...
    public function withDistance(QueryBuilder $query, array $where): string
    {
        ...
        return "{$this->STDistance($where['column'], $where['point'])} as {$alias}";
    }
    ...
    public function withDistanceSphere(QueryBuilder $query, array $where): string
    {
        ...
        return "{$this->STDistanceSphere($where['column'], $where['point'])} as {$alias}";
    }
    ...
    {
        return "{$this->STDistance($where['column'], $where['point'])} {$where['operator']} {$where['distance']}";
    }
    ...
    {
        return "{$this->STDistanceSphere($where['column'], $where['point'])} {$where['operator']} {$where['distance']}";
    }
